...
in the python project i learned about how sequence data types work in python especilally lists and tuples.

## Tests : heavy_check_mark:

*[tests](./tests): Folder of the gtest files.

##function prototype :floppy_disk:
prototypes for functions written in the project
| File                               | Prototype                                      |
| ---------------------------------- | ---------------------------------------------- |
...
* **0. Print all integers of a list.**
